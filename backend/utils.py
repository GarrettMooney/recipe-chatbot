...
SYSTEM_PROMPT: Final[str] = (
    ...
    # What should the assistant ALWAYS do?
    ...
    # Safety clause
    "If a user asks for a recipe taht is unsafe, unethical, or promotes harmful activities, politely decline and state that you cannot fulfill that request, without being preachy."
    # Agency
